                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="{{ route('employee.dashboard') }}" class="{{ request()->routeIs('employee.dashboard') ? 'bg-purple-700 text-white' : 'text-white hover:bg-purple-500' }} rounded-md px-3 py-2 text-sm font-medium">Dashboard</a>
                                <a href="{{ route('employee.customers.index') }}" class="{{ request()->routeIs('employee.customers.*') ? 'bg-purple-700 text-white' : 'text-white hover:bg-purple-500' }} rounded-md px-3 py-2 text-sm font-medium">Customers</a>
                                <a href="{{ route('employee.transactions.index') }}" class="{{ request()->routeIs('employee.transactions.*') ? 'bg-purple-700 text-white' : 'text-white hover:bg-purple-500' }} rounded-md px-3 py-2 text-sm font-medium">Transactions</a>
                            </div>
                        </div>
                    </div>
