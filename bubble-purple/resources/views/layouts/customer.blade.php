                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="{{ route('customer.dashboard') }}" class="{{ request()->routeIs('customer.dashboard') ? 'bg-purple-700 text-white' : 'text-white hover:bg-purple-500' }} rounded-md px-3 py-2 text-sm font-medium">Dashboard</a>
                                <a href="{{ route('customer.transactions.index') }}" class="{{ request()->routeIs('customer.transactions.*') ? 'bg-purple-700 text-white' : 'text-white hover:bg-purple-500' }} rounded-md px-3 py-2 text-sm font-medium">My Transactions</a>
                            </div>
                        </div>
                    </div>
